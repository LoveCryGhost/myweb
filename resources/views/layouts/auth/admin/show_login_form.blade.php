...
@section("user-title", "Admin Login")
        ...
        <div class="content-wrapper">
            ...
            <div class="content-inner">
                ...
                <div class="content d-flex justify-content-center align-items-center">
                    ...
                    <!-- Login form -->
                    <form class="login-form" action="{{route('auth.admin.login')}}" method="post">
                        @method('post')
                        @csrf
                        <div class="card mb-0">
                            <div class="card-body">
                                @include("layouts.common.show_error_massages")
                                ...
                                <div class="form-group d-flex align-items-center">
                                    ...
                                    <a href="{{route("auth.admin.register")}}" class="ml-auto">註冊</a>
                                </div>
